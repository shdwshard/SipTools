 ...
 */
public class UnknownAttributesAttribute extends GenericAttribute {
    ...
    public UnknownAttributesAttribute(AttributeType type, int length, byte[] value) {
    ...
    public UnknownAttributesAttribute(Collection<AttributeType> attrs) {
